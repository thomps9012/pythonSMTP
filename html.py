...
body = """<strong>Dear {first_name} {last_name},</strong>
            <br />
            <br />
            ...
            <br/>
            <br/>
            Some relevant skills I have related to this position are:
                <ol>
                <li>{skill1}</li>
                <li>{skill2}</li>
                <li>{skill3}</li>
            ...
            <br />
            <hr />
            <a target="_blank" href="https://sjtportfolio.herokuapp.com/"><p>Online Portfolio / Blog</p></a>
